	...
	return (
		<section ref={ref} className="flex flex-col text-white lg:m-auto lg:max-w-7xl lg:px-16">
			...
			<p className="leading-7 text-gray-500">
				...
				creating efficient, scalable, and user-friendly solutions that address real-world problems.
				I am known for my quick learning abilities and my commitment to closely collaborating with
				clients to deliver impactful applications.
			</p>
